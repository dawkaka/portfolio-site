...
const ProjectItem: FunctionComponent<{
  ...
  discrp: string;
  noLive: boolean;
}> = ({ noLive, image = "software.jpg", title, live, source, discrp }) => {
    ...
    >
      <div className={styles.projectItemInfo}>
        ...
        <div className={styles.sourceLive}>
          <div>
            {noLive ? (
              <button className={`${styles.button} ${disable}`}>Live</button>
            ) : (
              <a href={live} className={`${styles.button} ${disable}`}>
                Live
              </a>
            )}
          </div>
          <div>
            <a
              href={source}
              className={`${styles.button} ${styles.buttonLite}`}
            >
              Source
            </a>
          </div>
        ...
        <div>
          <div className={styles.projectMain}>
            ...
            <div className={styles.projectItemsContainer}>
              <ProjectItem
                title="A drawing web app"
                discrp="A good infinite canvas for drawing illustrations, diagrams etc"
                live="https://draaaw.vercel.app"
                source="https://github.com/dawkaka/drawapp"
                image="Capture5.png"
                noLive={false}
              />
              <ProjectItem
            ...
            <p>
              <a className={styles.findMore} href="https://github.com/dawkaka">
